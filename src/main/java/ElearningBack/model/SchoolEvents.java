...
public class SchoolEvents {
    ...
    public SchoolEvents(Integer yearEvent,Integer dayEvent,Integer monthEvent,String description,String link,String nameEvent,Integer Duration) {
